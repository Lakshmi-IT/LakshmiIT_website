...
const Hero = () => {
  return (
    <>
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Empowering Your Digital Future with Lakshmi IT
                </h1>
      ...
      <section className="body-font mt-5 text-gray-600">
        <div className="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
          <div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
            <p className="my-2 text-[18px] font-semibold dark:text-white">
              Welcome to LakshmiIT
            </p>
            <h1 className="title-font mb-4 text-[55px] font-medium text-gray-900 sm:text-4xl dark:text-white">
              {" "}
              Best Web Developement
            </h1>
            <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed sm:text-lg md:text-xl">
              Lakshmi Information Technology Private Limited offers tailored
